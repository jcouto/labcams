...
//gate counts
volatile long last_gate_rise = -1;
volatile long gate_count = 0;
...
#define GATE 'U' // signal the sync time
...
void gate_received() {
  if (digitalReadFast(PIN_GATE) == HIGH) {
    gate_count++;
    gating = 0;
  }
  else {
